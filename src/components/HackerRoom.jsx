...
const HackerRoom = ({ children, ...props }) =>  {
  const { nodes, materials } = useGLTF('/models/retro_computer_gltf/scene.gltf')
  return (
      ...
      <group scale={0.01}>
        <group position={[-25.4, -135.127, 186.97]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            castShadow
            receiveShadow
            geometry={nodes.cable023_Main_0.geometry}
        ...
        <group position={[-28.715, -139.589, 196.853]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            castShadow
            receiveShadow
            geometry={nodes.cable024_Main_0.geometry}
            material={materials.Main}
          />
          <mesh
            castShadow
        ...
        <group position={[260.734, -411.677, 165.877]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            castShadow
            receiveShadow
            geometry={nodes.cable037_Main_0.geometry}
            material={materials.Main}
          />
          <mesh
            castShadow
        ...
        <group position={[257.548, -428.844, -50.57]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            castShadow
            receiveShadow
            geometry={nodes.cable040_Main_0.geometry}
            material={materials.Main}
          />
          <mesh
            castShadow
        ...
        <group position={[272.945, -404.957, -59.792]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            castShadow
            receiveShadow
            geometry={nodes.cable041_Main_0.geometry}
            material={materials.Main}
          />
          <mesh
            castShadow
        ...
        <group position={[61.725, -139.153, -61.001]} rotation={[-Math.PI / 2, 0, 0]} scale={100}>
          <mesh
            castShadow
            receiveShadow
            geometry={nodes.Cable_Mass014_Main_0.geometry}
            material={materials.Main}
          />
          <mesh
            castShadow
...
useGLTF.preload('/models/retro_computer_gltf/scene.gltf')
