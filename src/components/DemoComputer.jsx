...
import { useGLTF } from '@react-three/drei'; // Correct import for useGLTF
import { useLoader } from '@react-three/fiber'; // Correct import for useLoader
...
const DemoComputer = (props) => {
  ...
  const txt = useLoader(TextureLoader, texturePath);
  txt.flipY = false; // Ensure the texture isn’t flipped vertically
  ...
  }, []); // No dependencies needed since we’re not animating the texture
